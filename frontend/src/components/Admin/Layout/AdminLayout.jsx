...
import { FaBox, FaTags, FaChartLine, FaSignOutAlt, FaRocket, FaGift, FaUsers, FaFunnelDollar, FaFileInvoiceDollar, FaCog } from 'react-icons/fa';
        ...
        <div className="flex h-screen bg-gray-100 font-sans">
            ...
            <aside className="w-64 bg-slate-900 text-white flex flex-col shadow-2xl flex-shrink-0">
                ...
                <div className="p-4 border-t border-slate-700">
                    <NavLink to="/" className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-slate-800 hover:bg-red-600 rounded-lg text-slate-300 hover:text-white transition-colors">
