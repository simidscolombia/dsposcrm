...
import { FaBox, FaTags, FaChartLine, FaSignOutAlt, FaRocket, FaGift, FaUsers, FaFunnelDollar, FaFileInvoiceDollar, FaTools, FaHandshake, FaHeadset, FaWhatsapp, FaBrain, FaImage } from 'react-icons/fa';
